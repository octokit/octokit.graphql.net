namespace Octokit.GraphQL
{
    ...
    public class Label : QueryEntity
    {
        ...
        public IssueConnection Issues(int? first = null, string after = null, int? last = null, string before = null) => this.CreateMethodCall(x => x.Issues(first, after, last, before), Octokit.GraphQL.IssueConnection.Create);
