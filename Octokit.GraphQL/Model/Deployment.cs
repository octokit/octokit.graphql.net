namespace Octokit.GraphQL.Model
{
    ...
    public class Deployment : QueryableValue<Deployment>
    {
        ...
        public DeploymentStatusConnection Statuses(Arg<string>? after = null, Arg<string>? before = null, Arg<int>? first = null, Arg<int>? last = null) => this.CreateMethodCall(x => x.Statuses(after, before, first, last), Octokit.GraphQL.Model.DeploymentStatusConnection.Create);
