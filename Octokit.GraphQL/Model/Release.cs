namespace Octokit.GraphQL.Model
{
    ...
    public class Release : QueryableValue<Release>
    {
        ...
        public ReleaseAssetConnection ReleaseAssets(Arg<string>? after = null, Arg<string>? before = null, Arg<int>? first = null, Arg<int>? last = null, Arg<string>? name = null) => this.CreateMethodCall(x => x.ReleaseAssets(after, before, first, last, name), Octokit.GraphQL.Model.ReleaseAssetConnection.Create);
