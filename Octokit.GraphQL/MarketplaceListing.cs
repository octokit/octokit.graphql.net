namespace Octokit.GraphQL
{
    ...
    public class MarketplaceListing : QueryEntity
    {
        ...
        /// </summary>
        public MarketplaceCategory PrimaryCategory => this.CreateProperty(x => x.PrimaryCategory, Octokit.GraphQL.MarketplaceCategory.Create);
        ...
        /// </summary>
        public MarketplaceCategory SecondaryCategory => this.CreateProperty(x => x.SecondaryCategory, Octokit.GraphQL.MarketplaceCategory.Create);
