namespace Octokit.GraphQL
{
    ...
    public class ProjectColumn : QueryEntity
    {
        ...
        public ProjectCardConnection Cards(int? first = null, string after = null, int? last = null, string before = null) => this.CreateMethodCall(x => x.Cards(first, after, last, before), Octokit.GraphQL.ProjectCardConnection.Create);
