namespace Octokit.GraphQL
{
    ...
    /// </summary>
    public class RenamedEvent : QueryEntity
    {
        public RenamedEvent(IQueryProvider provider, Expression expression) : base(provider, expression)
        {
        }
        ...
        internal static RenamedEvent Create(IQueryProvider provider, Expression expression)
        {
            return new RenamedEvent(provider, expression);
        }
    }
}