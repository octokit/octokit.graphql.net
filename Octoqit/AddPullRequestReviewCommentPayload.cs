namespace Octoqit
{
    ...
    public class AddPullRequestReviewCommentPayload : QueryEntity
    {
        ...
        /// </summary>
        public PullRequestReviewComment Comment => this.CreateProperty(x => x.Comment, Octoqit.PullRequestReviewComment.Create);

        /// <summary>
        /// The edge from the review's comment connection.
        /// </summary>
        public PullRequestReviewCommentEdge CommentEdge => this.CreateProperty(x => x.CommentEdge, Octoqit.PullRequestReviewCommentEdge.Create);
