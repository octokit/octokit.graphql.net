namespace Octoqit
{
    ...
    public class Team : QueryEntity
    {
        ...
        public OrganizationInvitationConnection Invitations(int? first, string after, int? last, string before) => this.CreateMethodCall(x => x.Invitations(first, after, last, before), Octoqit.OrganizationInvitationConnection.Create);
