namespace Octoqit
{
    ...
    public class PullRequest : QueryEntity
    {
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified global ID.</param>
        public CommitConnection Commits(int? first, string after, int? last, string before) => this.CreateMethodCall(x => x.Commits(first, after, last, before), Octoqit.CommitConnection.Create);
        ...
        /// <param name="last">Returns the last _n_ elements from the list.</param>
        /// <param name="before">Returns the elements in the list that come before the specified global ID.</param>
        public ReviewRequestConnection ReviewRequests(int? first, string after, int? last, string before) => this.CreateMethodCall(x => x.ReviewRequests(first, after, last, before), Octoqit.ReviewRequestConnection.Create);
        ...
        public PullRequestReviewConnection Reviews(int? first, string after, int? last, string before, IQueryable<PullRequestReviewState> states) => this.CreateMethodCall(x => x.Reviews(first, after, last, before, states), Octoqit.PullRequestReviewConnection.Create);
